...
namespace IfacesEnumsStructsClasses
{
    ...
    public sealed class HTMLDispIDs
    {
        ...
        public const int DISPID_HTMLSELECTELEMENTEVENTS2_ONCHANGE = DISPID_EVMETH_ONCHANGE;

        //    DISPIDs for interface IHTMLTextRangeMetrics
        public const int DISPID_IHTMLTEXTRANGEMETRICS_OFFSETTOP = DISPID_RANGE + 35; //1035
        public const int DISPID_IHTMLTEXTRANGEMETRICS_OFFSETLEFT = DISPID_RANGE + 36;
        public const int DISPID_IHTMLTEXTRANGEMETRICS_BOUNDINGTOP = DISPID_RANGE + 37;
        public const int DISPID_IHTMLTEXTRANGEMETRICS_BOUNDINGLEFT = DISPID_RANGE + 38;
        public const int DISPID_IHTMLTEXTRANGEMETRICS_BOUNDINGWIDTH = DISPID_RANGE + 39;
        public const int DISPID_IHTMLTEXTRANGEMETRICS_BOUNDINGHEIGHT = DISPID_RANGE + 40;

        //    DISPIDs for interface IHTMLTextRangeMetrics2

        public const int DISPID_IHTMLTEXTRANGEMETRICS2_GETCLIENTRECTS = DISPID_RANGE+41;
        public const int DISPID_IHTMLTEXTRANGEMETRICS2_GETBOUNDINGCLIENTRECT = DISPID_RANGE + 42;

        //    DISPIDs for event set HTMLScriptEvents2

        public const int DISPID_HTMLSCRIPTEVENTS2_ONERROR = DISPID_EVMETH_ONERROR;

        //    DISPIDs for IHTMLXMLHTTPREQUEST
        public const int DISPID_XMLHTTPREQUEST = DISPID_NORMAL_FIRST;
        public const int DISPID_IHTMLXMLHTTPREQUEST_READYSTATE = DISPID_XMLHTTPREQUEST + 2;
        public const int DISPID_IHTMLXMLHTTPREQUEST_RESPONSEBODY = DISPID_XMLHTTPREQUEST + 3;
        public const int DISPID_IHTMLXMLHTTPREQUEST_RESPONSETEXT = DISPID_XMLHTTPREQUEST + 4;
        public const int DISPID_IHTMLXMLHTTPREQUEST_RESPONSEXML = DISPID_XMLHTTPREQUEST + 5;
        public const int DISPID_IHTMLXMLHTTPREQUEST_STATUS = DISPID_XMLHTTPREQUEST + 6;
        public const int DISPID_IHTMLXMLHTTPREQUEST_STATUSTEXT = DISPID_XMLHTTPREQUEST + 7;
        public const int DISPID_IHTMLXMLHTTPREQUEST_ONREADYSTATECHANGE = DISPID_XMLHTTPREQUEST + 8;
        public const int DISPID_IHTMLXMLHTTPREQUEST_ABORT = DISPID_XMLHTTPREQUEST + 9;
        public const int DISPID_IHTMLXMLHTTPREQUEST_OPEN = DISPID_XMLHTTPREQUEST + 10;
        public const int DISPID_IHTMLXMLHTTPREQUEST_SEND = DISPID_XMLHTTPREQUEST + 11;
        public const int DISPID_IHTMLXMLHTTPREQUEST_GETALLRESPONSEHEADERS = DISPID_XMLHTTPREQUEST + 12;
        public const int DISPID_IHTMLXMLHTTPREQUEST_GETRESPONSEHEADER = DISPID_XMLHTTPREQUEST + 13;
        public const int DISPID_IHTMLXMLHTTPREQUEST_SETREQUESTHEADER = DISPID_XMLHTTPREQUEST + 14;

        //    DISPIDs for interface IHTMLXMLHttpRequestFactory
        public const int DISPID_IHTMLXMLHTTPREQUESTFACTORY_CREATE = DISPID_VALUE;

        //    DISPIDs for interface IHTMLWindow5
        public const int DISPID_IHTMLWINDOW5_XMLHTTPREQUEST = 1190;

        //    DISPIDs for interface IHTMLLinkElement
        public const int DISPID_IHTMLLINKELEMENT_HREF = DISPID_HEDELEMS + 5;
        public const int DISPID_IHTMLLINKELEMENT_REL = DISPID_HEDELEMS + 6;
        public const int DISPID_IHTMLLINKELEMENT_REV = DISPID_HEDELEMS + 7;
        public const int DISPID_IHTMLLINKELEMENT_TYPE = DISPID_HEDELEMS + 8;
        public const int DISPID_IHTMLLINKELEMENT_READYSTATE = DISPID_A_READYSTATE;
        public const int DISPID_IHTMLLINKELEMENT_ONREADYSTATECHANGE = DISPID_EVPROP_ONREADYSTATECHANGE;
        public const int DISPID_IHTMLLINKELEMENT_ONLOAD = DISPID_EVPROP_ONLOAD;
        public const int DISPID_IHTMLLINKELEMENT_ONERROR = DISPID_EVPROP_ONERROR;
        public const int DISPID_IHTMLLINKELEMENT_STYLESHEET = DISPID_HEDELEMS + 14;
        public const int DISPID_IHTMLLINKELEMENT_DISABLED = STDPROPID_XOBJ_DISABLED;
        public const int DISPID_IHTMLLINKELEMENT_MEDIA = DISPID_HEDELEMS + 16;

        //    DISPIDs for interface IHTMLLinkElement2
        public const int DISPID_IHTMLLINKELEMENT2_TARGET = DISPID_HEDELEMS + 17;

        //    DISPIDs for interface IHTMLLinkElement3
        public const int DISPID_IHTMLLINKELEMENT3_CHARSET = DISPID_HEDELEMS + 18;
        public const int DISPID_IHTMLLINKELEMENT3_HREFLANG = DISPID_HEDELEMS + 19;

        //    DISPIDs for interface IHTMLStyleSheet
        public const int DISPID_STYLESHEET = DISPID_NORMAL_FIRST;
        public const int DISPID_IHTMLSTYLESHEET_TITLE = DISPID_STYLESHEET + 1;
        public const int DISPID_IHTMLSTYLESHEET_PARENTSTYLESHEET = DISPID_STYLESHEET + 2;
        public const int DISPID_IHTMLSTYLESHEET_OWNINGELEMENT = DISPID_STYLESHEET + 3;
        public const int DISPID_IHTMLSTYLESHEET_DISABLED = STDPROPID_XOBJ_DISABLED;
        public const int DISPID_IHTMLSTYLESHEET_READONLY = DISPID_STYLESHEET + 4;
        public const int DISPID_IHTMLSTYLESHEET_IMPORTS = DISPID_STYLESHEET + 5;
        public const int DISPID_IHTMLSTYLESHEET_HREF = DISPID_STYLESHEET + 6;
        public const int DISPID_IHTMLSTYLESHEET_TYPE = DISPID_STYLESHEET + 7;
        public const int DISPID_IHTMLSTYLESHEET_ID = DISPID_STYLESHEET + 8;
        public const int DISPID_IHTMLSTYLESHEET_ADDIMPORT = DISPID_STYLESHEET + 9;
        public const int DISPID_IHTMLSTYLESHEET_ADDRULE = DISPID_STYLESHEET + 10;
        public const int DISPID_IHTMLSTYLESHEET_REMOVEIMPORT = DISPID_STYLESHEET + 11;
        public const int DISPID_IHTMLSTYLESHEET_REMOVERULE = DISPID_STYLESHEET + 12;
        public const int DISPID_IHTMLSTYLESHEET_MEDIA = DISPID_STYLESHEET + 13;
        public const int DISPID_IHTMLSTYLESHEET_CSSTEXT = DISPID_STYLESHEET + 14;
        public const int DISPID_IHTMLSTYLESHEET_RULES = DISPID_STYLESHEET + 15;

        //    DISPIDs for interface IHTMLStyleSheet2
        public const int DISPID_IHTMLSTYLESHEET2_PAGES = DISPID_STYLESHEET + 16;
        public const int DISPID_IHTMLSTYLESHEET2_ADDPAGERULE = DISPID_STYLESHEET + 17;
    }
}
